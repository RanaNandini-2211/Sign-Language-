...
while(1):
    ...
    contours, hierarchy = cv2.findContours(threshSkinColor,cv2.RETR_TREE,cv2.CHAIN_APPROX_SIMPLE)
    ...
    if('cnt' in globals()):
        ...
        #HOG
        (H, hogImage) = feature.hog(gray,orientations=9, pixels_per_cell=(8, 8),cells_per_block=(2, 2), transform_sqrt=True, visualize=True)
